...
$(document).ready(function () {
    ...
    getFromStore('portOverride', function (data) {
    ...
    $('div.connect_controls a.connect').click(function () {
        if (GUI.connect_lock != true) { // GUI control overrides the user control
            ...
            if (selected_port === 'DFU') {
                GUI.log(i18nGetMessage('dfu_connect_message'));
            }
                ...
                if (!clicks) {
                    ...
                    $('div.connect_controls a.connect_state').text(i18nGetMessage('connecting'));
                    ...
                    $('div.connect_controls a.connect_state').text(i18nGetMessage('connect'));
    ...
    // auto-connect
    getFromStore('auto_connect', function (result) {
        if (result.auto_connect === 'undefined' || result.auto_connect) {
            // default or enabled by user
            GUI.auto_connect = true;

            $('input.auto_connect').prop('checked', true);
            $('input.auto_connect, span.auto_connect').prop('title', i18nGetMessage('autoConnectEnabled'));
            ...
            $('input.auto_connect, span.auto_connect').prop('title', i18nGetMessage('autoConnectDisabled'));
        }
...
function onOpen(openInfo) {
    if (openInfo) {
        ...
        GUI.log(i18nGetMessage('serialPortOpened', [openInfo.connectionId]));
        ...
        GUI.timeout_add('connecting', function () {
            if (!CONFIGURATOR.connectionValid) {
                GUI.log(i18nGetMessage('noConfigurationReceived'));
        ...
        MSP.send_message(MSPCodes.MSP_API_VERSION, false, false, function () {
            GUI.log(i18nGetMessage('apiVersionReceived', [CONFIG.apiVersion]));
            ...
            if (semver.gte(CONFIG.apiVersion, CONFIGURATOR.apiVersionAccepted)) {
                ...
                MSP.send_message(MSPCodes.MSP_FC_VARIANT, false, false, function () {
                    if (CONFIG.flightControllerIdentifier === 'BTFL') {
                        MSP.send_message(MSPCodes.MSP_FC_VERSION, false, false, function () {
                            ...
                            GUI.log(i18nGetMessage('fcInfoReceived', [CONFIG.flightControllerIdentifier, CONFIG.flightControllerVersion]));

                            MSP.send_message(MSPCodes.MSP_BUILD_INFO, false, false, function () {

                                GUI.log(i18nGetMessage('buildInfoReceived', [CONFIG.buildInfo]));

                                MSP.send_message(MSPCodes.MSP_BOARD_INFO, false, false, function () {

                                    GUI.log(i18nGetMessage('boardInfoReceived', [CONFIG.boardIdentifier, CONFIG.boardVersion]));

                                    MSP.send_message(MSPCodes.MSP_UID, false, false, function () {
                                        GUI.log(i18nGetMessage('uniqueDeviceIdReceived', [CONFIG.uid[0].toString(16) + CONFIG.uid[1].toString(16) + CONFIG.uid[2].toString(16)]));
                        ...
                        GUI.show_modal(i18nGetMessage('warningTitle'),
                            i18nGetMessage('firmwareTypeNotSupported'));
                ...
                GUI.show_modal(i18nGetMessage('warningTitle'),
                    i18nGetMessage('firmwareVersionNotSupported', [CONFIGURATOR.apiVersionAccepted]));
        ...
        GUI.log(i18nGetMessage('serialPortOpenFail'));

        $('div#connectbutton a.connect_state').text(i18nGetMessage('connect'));
...
function onConnect() {
    ...
    $('div#connectbutton a.connect_state').text(i18nGetMessage('disconnect')).addClass('active');
...
function onClosed(result) {
    if (result) { // All went as expected
        GUI.log(i18nGetMessage('serialPortClosedOk'));
    } else { // Something went wrong
        GUI.log(i18nGetMessage('serialPortClosedFail'));
    }
