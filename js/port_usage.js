...
var PortUsage = {
    ...
    update: function() {
        if (serial.bitrate) {
            ...
            // update UI
            $('span.port_usage_down').text(i18nGetMessage('statusbar_usage_download', [port_usage_down]));
            $('span.port_usage_up').text(i18nGetMessage('statusbar_usage_upload', [port_usage_up]));
        } else {
            $('span.port_usage_down').text(i18nGetMessage('statusbar_usage_download', [0]));
            $('span.port_usage_up').text(i18nGetMessage('statusbar_usage_upload', [0]));
        }
    },
    reset: function() {
